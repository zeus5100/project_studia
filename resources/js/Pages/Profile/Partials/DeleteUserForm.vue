  ...
  <section class="space-y-6">
    <header>
      ...
      <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
        ...
        Przed usunięciem konta, proszę pobierz wszelkie dane lub informacje,
    ...
    <Modal :show="confirmingUserDeletion" @close="closeModal">
      <div class="p-6">
        ...
        <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
          ...
          usunięte. Przed usunięciem konta, proszę pobierz wszelkie dane lub
          informacje, które chcesz zachować.
        </p>
